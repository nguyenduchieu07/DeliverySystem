        ...
        items.forEach((it) => {
          ...
          el.innerHTML = `
                        <div class="autocomplete-item-main">${
                          it.name || (it.display_name || "").split(",")[0]
                        }</div>
  ...
  warehouses.forEach((warehouse) => {
    ...
    item.innerHTML = `
            <div class="warehouse-name">${
              warehouse.name || warehouse.Name || "Kho"
            }</div>
    ...
    if (bookBtn) {
        ...
        try {
            ...
            if (
              ...
              result.quote.itemEstimates.forEach((item, idx) => {
                console.log(
                  `  ${idx + 1}. ${item.name}: ${item.quantity} cái, ${
            ...
            <div style="background: white; border-radius: 16px; max-width: 800px; width: 100%; max-height: 90vh; overflow-y: auto; box-shadow: 0 10px 40px rgba(0,0,0,0.3);">
                ...
                <div style="padding: 24px;">
                    ...
                    <div style="margin-bottom: 24px; padding: 16px; background: #f8f9fa; border-radius: 8px;">
                        ...
                        <p style="margin: 4px 0;"><strong>Tên kho:</strong> ${
                          quote.warehouseName || "N/A"
                        }</p>
                        <p style="margin: 4px 0;"><strong>Địa chỉ:</strong> ${
                          quote.warehouseAddress || "N/A"
                        }</p>
                    </div>
                    ...
                    <div style="margin-bottom: 24px; padding: 16px; background: #fff3cd; border-radius: 8px; border-left: 4px solid #ffc107;">
                        ...
                        <p style="margin: 8px 0 4px 0;"><strong>Mã slot:</strong> ${
                          quote.slotCode || "N/A"
                        }</p>
                        <p style="margin: 4px 0;"><strong>Kích thước:</strong> ${
                          quote.slotDimensions ||
                          `${quote.slotLengthM || 0}m × ${
                            quote.slotWidthM || 0
                    ...
                    <div style="margin-bottom: 24px; padding: 16px; background: #f8f9fa; border-radius: 8px;">
                        ...
                        <p style="margin: 4px 0;"><strong>Từ ngày:</strong> ${
                          quote.storageStartDate || "N/A"
                        }</p>
                        <p style="margin: 4px 0;"><strong>Đến ngày:</strong> ${
                          quote.storageEndDate || "N/A"
                        }</p>
                        <p style="margin: 4px 0;"><strong>Thời gian:</strong> ${
                          quote.storageDurationDays ||
                        ...
                        <table style="width: 100%; border-collapse: collapse;">
                            ...
                            <tr style="border-bottom: 1px solid #ddd;">
                                ...
                                <td style="text-align: right; padding: 8px 0;">
                                    ${formatCurrency(addon.unitPrice || 0)}${
                                  addon.isDaily ? "/ngày" : ""
                                } 
                                    ${
                                      addon.isDaily
                    ...
                    <div style="display: flex; gap: 12px; margin-top: 24px;">
                        ...
                        <button onclick="confirmAssignSlotToOrder('${orderId}', '${
    quote.slotId || ""
